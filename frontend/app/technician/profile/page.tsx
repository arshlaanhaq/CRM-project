...
export default function technicianProfilePage() {
  ...
  const { getTechnicianProfile, updateTechnicianProfile } = useApi()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedProfile = await updateTechnicianProfile(finalData)
    ...
    <LayoutWithSidebar>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          <Link href="/technician-dashboard" className="mr-4">
